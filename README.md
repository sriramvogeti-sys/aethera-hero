...
build the same clone for ascend landing webpage

This project was built with [Lovable](https://lovable.dev).

## Build with Lovable

Continue developing this project in the [Lovable editor](https://lovable.dev/projects/64b0f5a8-ba3b-47ef-9b76-e83bee266803).
